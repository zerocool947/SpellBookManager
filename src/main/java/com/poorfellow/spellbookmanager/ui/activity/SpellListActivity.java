...
/**
 * An activity representing a list of Spells. This activity has different
 * presentations for handset and tablet-size devices. On handsets, the activity
 * presents a list of items, which when touched, lead to a
 * {@link SpellDetailActivity} representing item details. On tablets, the
 * activity presents the list of items and item details side-by-side using two
 * vertical panes.
 * <p>
 * The activity makes heavy use of fragments. The list of items is a
 * {@link SpellListFragment} and the item details (if present) is a
 * {@link SpellDetailFragment}.
 * <p>
 * This activity also implements the required
 * {@link SpellListFragment.Callbacks} interface to listen for item selections.
 */
public class SpellListActivity extends FragmentActivity implements
		SpellListFragment.Callbacks {
	...
	/**
	 * Callback method from {@link SpellListFragment.Callbacks} indicating that
	...
	public void onItemSelected(String id) {
		if (mTwoPane) {
			...
			getSupportFragmentManager().beginTransaction()
					.replace(R.id.spell_detail_container, fragment).commit();
